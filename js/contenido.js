...
function AgregarTitulo(){
    ...
    contenido.innerHTML = contenido.innerHTML + '<h1>' + titulo + '</h1>';
}

function AgregarLink(){
    var contenido = document.getElementById('contenido');
    var texto = document.getElementById('texto').value;
    var info_link = texto.split(', ');
    contenido.innerHTML = contenido.innerHTML + '<a href="' + info_link[0] + '" target="_blank">' + info_link[1] + '</a>';
}
